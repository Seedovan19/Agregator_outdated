...
func (s *WarehouseService) Add_warehouse_record(warehouse_data agregator.Warehouse, building_data agregator.Building) (int, error) {
	return s.repo.Add_warehouse_record(warehouse_data, building_data)
}
